package com.matthew.matthewlibrary.utils
...
object KLog {
    ...
    fun d_(msg: Any?,index:Int) {
        printLog(D, null, msg,index)
    }
    ...
    fun e_(msg: Any?,index:Int) {
        printLog(E, null, msg,index)
    }
    ...
    private fun printLog(type: Int, tagStr: String?, objectMsg: Any?, index: Int = 5) {
        val msg: String
        if (!IS_SHOW_LOG) {
            return
        }
